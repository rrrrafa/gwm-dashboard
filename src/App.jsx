...
const CDATA = {
  ...
  SA:{flag:"🇸🇦",name:"Arábia Saudita",aliases:["Saudi Arabia"]},
  TH:{flag:"🇹🇭",name:"Tailândia",aliases:["Thailand"]},
  KR:{flag:"🇰🇷",name:"Coreia do Sul",aliases:["South Korea","Korea, Republic of"]},
  UA:{flag:"🇺🇦",name:"Ucrânia",aliases:["Ukraine"]},
  FI:{flag:"🇫🇮",name:"Finlândia",aliases:["Finland"]},
  TR:{flag:"🇹🇷",name:"Turquia",aliases:["Turkey","Türkiye"]},
  TW:{flag:"🇹🇼",name:"Taiwan",aliases:["Taiwan"]},
  GE:{flag:"🇬🇪",name:"Geórgia",aliases:["Georgia"]},
  VN:{flag:"🇻🇳",name:"Vietnã",aliases:["Vietnam"]},
  ID:{flag:"🇮🇩",name:"Indonésia",aliases:["Indonesia"]},
  EE:{flag:"🇪🇪",name:"Estônia",aliases:["Estonia"]},
  EG:{flag:"🇪🇬",name:"Egito",aliases:["Egypt"]},
};
